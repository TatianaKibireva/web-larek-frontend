...
export class OrderPresenter {
  ...
  constructor(protected events: IEvents, orderTemplate: HTMLTemplateElement, cardModel: CardModel<any>) {
    ...
    this.paymentButtons = Array.from(this.formContainer.querySelectorAll('.order__buttons .button'));
    this.addressInput = ensureElement<HTMLInputElement>('input[name="address"]', this.formContainer);
